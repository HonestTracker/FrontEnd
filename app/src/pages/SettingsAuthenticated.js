...
function SettingsAuthenticated() {
  ...
  return (
    <main class="p-48" style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      <input 
        type="text" 
        className="text-customGray border-2 border-gray-200 rounded-md p-2 pl-10 h-12 w-full focus:outline-none focus:border-blue-500"
      />
      <icons.Pencil style={{ 
        width: "20px", 
        height: "20px", 
      ...
      <icons.Pencil style={{ 
        ...
        height: "20px", 
        position: "absolute", 
        right: 16, // Adjust as needed to place the icon appropriately
    ...
    <div class="flex justify-center space-x-4 mt-4">
        ...
        <div>
          ...
          <select id="currency" class="text-customGray border-2 border-gray-200 rounded-md p-2 ml-6  pr-28 w-56">
            <option>Euro</option>
            <option>USD</option>
            <option>GBP</option>
          </select>
      ...
      <icons.Pencil style={{ 
        ...
        height: "20px", 
        position: "absolute", 
        right: 80, // Adjust as needed to place the icon appropriately
        top: "20%", // Center vertically
        transform: "translateY(-80%)" // Ensure it is perfectly centered
      }} />
            </div>

            <div class="mb-4">
            <p class="text-xl mt-6">Repeat new password</p>
            <input type="text" class="text-customGray border-2 border-gray-200 rounded-md p-2 w-11/12" placeholder="Type here"/>
            </div>
            <div class="flex justify-center space-x-4 mt-4">
                <button class="text-customGray border-2 border-gray-200 rounded-md p-2  w-28" >Cancel</button>
                <button className="bg-teal-400 cursor-pointer text-white  ml-6 p-2 rounded hover:bg-teal-300 w-28">Save</button>
