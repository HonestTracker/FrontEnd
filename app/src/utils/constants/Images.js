export const images = {
  logoFNBG: require("../../assets/images/logo.png"),
  footerLogo: require("../../assets/images/honesttracker-footer-logo.png"),
  placeholder: require("../../assets/images/placeholder/placeholder.jpg"),
